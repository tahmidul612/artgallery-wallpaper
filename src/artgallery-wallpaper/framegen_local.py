"""
Artgallery Wallpaper - Frame generation with AI using Stable Diffusion + ControlNet.
Compatible with diffusers>=0.25.0 and transformers>=4.36.0

Features:
- Automatic corner image scaling to fit frame dimensions
- Memory-efficient SD 1.5 generation with ControlNet inpainting
- Symmetrical frame assembly with seam blending
- Transparent interior for artwork placement
- GPU memory optimization for different VRAM levels
"""
...
# Import background removal from separate module
try:
